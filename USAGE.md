...
**Important:** Add `bg-background text-foreground` to your body element to use the DDS theme colors. These utility classes will automatically switch in dark mode.
